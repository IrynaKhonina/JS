...
for (let i = 0; i < bills.length; i++) {
    const tip = culculateTips(bills[i]);
    tips.push(tip);
    totalBills.push(bills[i] + tip);
}

const culculateAverage = function (arr) {
    let sum = 0;
...
const averageTip = culculateAverage(tips);
const averageTotalBill = culculateAverage(totalBills);

console.log("Tips:", tips);
console.log("Total Bills:", totalBills);
console.log("Average Tip:", averageTip);
console.log("Average Total Bill:", averageTotalBill);
